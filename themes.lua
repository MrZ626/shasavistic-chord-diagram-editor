local themes = {
    ...
    bright = {
        ...
        dim = {
            ...
            -- Add more dimensions here (optional, will be auto-filled with faded colors if not provided)
        },
        dimGridColor = {
...
TABLE.update(themes.bright.dim, themes.dark.dim)
TABLE.update(themes.bright.dimGridColor, themes.dark.dimGridColor)
